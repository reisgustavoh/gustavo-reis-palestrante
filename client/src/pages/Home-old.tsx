...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section
        id="hero"
        className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-primary via-primary/90 to-primary/80 overflow-hidden"
      >
        ...
        <div className="container relative z-10 py-12 md:py-20 px-4">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center max-w-7xl mx-auto">
            ...
            <Badge className="mb-4 md:mb-6 bg-accent text-accent-foreground border-none text-xs md:text-sm px-3 md:px-4 py-1.5 md:py-2 font-semibold">
              <Award className="h-4 w-4 mr-2 inline" />
              Diretor de IA na HopAI | Professor FDC | +R$750M em resultados gerados com IA
            </Badge>
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl mb-3 md:mb-4 text-white/90 max-w-3xl mx-auto lg:mx-0 font-medium">
              Do boardroom ao chão de fábrica: palestras que capacitam toda a organização para o uso, governança e adoção em escala de IA com resultados comprovados e segurança
            </p>
            
            <p className="text-sm sm:text-base md:text-lg mb-6 md:mb-8 text-white/80 max-w-2xl mx-auto lg:mx-0">
              Experiência real de quem já implementou 700+ modelos de IA gerando R$750 milhões em
              impacto para empresas como Azul, Hapvida e Vallourec
            </p>

            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center lg:justify-start mb-8 md:mb-12">
              <Button
                size="lg"
                className="text-base md:text-lg bg-secondary hover:bg-secondary/90 text-secondary-foreground border-none shadow-xl font-semibold"
                onClick={() => {
                  const element = document.getElementById("contato");
                  element?.scrollIntoView({ behavior: "smooth" });
                }}
              >
                Quero uma Palestra <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
              <Button
                size="lg"
                variant="outline"
                className="text-base md:text-lg bg-white/10 border-white/30 text-white hover:bg-white/20 backdrop-blur"
                onClick={() => {
                  const element = document.getElementById("palestras");
                  element?.scrollIntoView({ behavior: "smooth" });
                }}
              >
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-4">
              <div className="bg-white/10 backdrop-blur rounded-lg p-3 md:p-4 border border-white/20">
              ...
              <div className="bg-white/10 backdrop-blur rounded-lg p-3 md:p-4 border border-white/20">
                ...
                <p className="text-xs md:text-sm text-white/80">em Resultados Gerados</p>
              </div>
              <div className="bg-white/10 backdrop-blur rounded-lg p-3 md:p-4 border border-white/20">
                <p className="text-2xl md:text-3xl font-bold text-accent">20 anos</p>
                <p className="text-xs md:text-sm text-white/80">de Experiência</p>
              </div>
              <div className="bg-white/10 backdrop-blur rounded-lg p-3 md:p-4 border border-white/20">
          ...
          <div className="order-1 lg:order-2 flex items-center justify-center lg:justify-end">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-accent/30 to-secondary/30 rounded-full blur-3xl"></div>
              <img
                src="/gustavo-reis-profile.png"
                alt="Gustavo Reis - Palestrante especialista em IA e Governança"
                className="relative w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 object-cover rounded-full border-4 border-white/20 shadow-2xl"
              />
            </div>
          </div>
        </div>
